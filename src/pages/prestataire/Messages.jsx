...
const PrestataireMessages = () => {
  ...
  const fetchMissions = async () => {
    ...
    const { data } = await supabase
      ...
      .select(`
        *,
        client:profiles!missions_client_id_fkey(id, nom, avatar_url)
      `)
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-medium text-gray-900 truncate">{mission.client?.nom}</p>
          ...
          {!selectedMission ? (
            ...
            <>
              <div className="px-4 py-3 border-b border-gray-100 flex items-center gap-3 flex-shrink-0">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-medium text-gray-900 truncate">{selectedMission.client?.nom}</p>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                {messages.length === 0 ? (
                  <div className="flex items-center justify-center h-full">
                    <p className="text-gray-400 text-xs font-light">Aucun message. Demarrez la conversation !</p>
                  </div>
                ) : (
                  messages.map((msg, i) => {
