    ...
    const { data } = await supabase
      ...
      .select(`
        *,
        ...
        prestataire:profiles!missions_prestataire_id_fkey(nom, localisation)
      `)
          ...
          <div className="space-y-3">
            {missionsFiltrees.map((mission) => (
              <div key={mission.id}
                ...
                <div className="flex items-center gap-4 text-xs text-gray-400 font-light mb-3">
                  ...
                  <div className="flex items-center gap-2 mb-3 p-3 bg-gray-50 rounded-lg">
                    <div className="w-6 h-6 bg-gray-900 rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-white text-xs">
                        {mission.prestataire.nom?.charAt(0).toUpperCase()}
                      </span>
                    </div>
                    <div>
                      ...
                      <p className="text-xs text-gray-400 font-light">
                        {mission.prestataire.localisation}
                      </p>
                    </div>
                  </div>
                )}
                ...
                <div className="flex gap-2 mt-3">
                  {mission.statut === 'en_attente' && (
                    <button
                      onClick={() => handleAnnuler(mission.id)}
